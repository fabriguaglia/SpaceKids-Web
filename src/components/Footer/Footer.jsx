...
function Footer() {
  ...
  const handleLinkedIn = () => {
    window.open('https://www.linkedin.com/company/spacekids-foundation/?originalSubdomain', '_blank');
  };
      ...
      <div className="footer-content">
        ...
        <div className="footer-left">
          <p className="footer-text">
            <strong>© 2025 Space Kids Foundation</strong>
            <br />
            Fomentar la educación inclusiva para los jóvenes y niños
          </p>
        </div>

        {/* Sección central: Logo */}
        <div className="footer-center">
          <a href="/" className="logo-link" aria-label="Logo Space Kids Foundation">
            <img
              src={Logopng}
              alt="Logo Space Kids Foundation"
