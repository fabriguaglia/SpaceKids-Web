...
function Nosotros() {
  ...
  return (
    <div className="fixed top-0 left-0 w-screen h-screen overflow-hidden bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      <div 
        ref={containerRef}
      ...
      >
        ...
        <section className="w-screen h-screen flex flex-col items-center justify-center px-16 flex-shrink-0">
          <h2 className="text-6xl font-bold text-white mb-8 drop-shadow-[0_0_15px_rgba(255,255,255,0.5)]">
            Quiénes Somos
          </h2>
          <div className="max-w-4xl text-white leading-relaxed text-2xl text-center">
            <p>
          ...
          <div className="max-w-5xl">
            ...
            <div className="grid grid-cols-3 gap-12">
              <div className="text-center">
                <div className="w-32 h-32 bg-slate-600 rounded-full mx-auto mb-4"></div>
                <h3 className="font-bold text-2xl text-white">[Nombre]</h3>
                <p className="text-slate-300 text-lg">[Cargo]</p>
              </div>
              <div className="text-center">
                <div className="w-32 h-32 bg-slate-600 rounded-full mx-auto mb-4"></div>
                <h3 className="font-bold text-2xl text-white">[Nombre]</h3>
